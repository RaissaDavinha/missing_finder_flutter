          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(4.0, 0.0, 304.5, 257.0),
                    size: Size(308.5, 257.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 201.0, 304.5, 1.0),
                    size: Size(308.5, 257.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(147.8, 219.0, 18.0, 19.0),
                    size: Size(308.5, 257.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
