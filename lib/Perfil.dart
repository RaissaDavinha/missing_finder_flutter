          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 352.5, 435.0),
                    size: Size(352.5, 435.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(38.0, 27.0, 186.0, 97.0),
                    size: Size(352.5, 435.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 51.0, 21.0),
                          size: Size(186.0, 97.0),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 22.0, 186.0, 21.0),
                          size: Size(186.0, 97.0),
                          pinLeft: true,
                          pinRight: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 54.0, 68.0, 21.0),
                          size: Size(186.0, 97.0),
                          pinLeft: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 76.0, 142.0, 21.0),
                          size: Size(186.0, 97.0),
                          pinLeft: true,
                          pinBottom: true,
                          fixedWidth: true,
