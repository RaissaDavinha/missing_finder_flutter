    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(60.0, 348.0),
            child:
                // Adobe XD layer: 'Card' (group)
                GestureDetector(
              onTap: () => ThankPopup?.call(),
              child: SizedBox(
                width: 295.0,
                height: 200.0,
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 295.0, 200.0),
                      size: Size(295.0, 200.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(0.0, 143.0, 295.0, 1.0),
                            size: Size(295.0, 200.0),
                            pinLeft: true,
                            pinRight: true,
                            fixedHeight: true,
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(111.0, 36.0, 74.0, 19.0),
                            size: Size(295.0, 200.0),
                            fixedWidth: true,
                            fixedHeight: true,
                            child: Text(
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(139.0, 162.0, 18.0, 19.0),
                            size: Size(295.0, 200.0),
                            pinBottom: true,
                            fixedWidth: true,
                            fixedHeight: true,
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(69.0, 77.0, 157.0, 46.0),
                            size: Size(295.0, 200.0),
                            pinLeft: true,
                            pinRight: true,
                            fixedHeight: true,
